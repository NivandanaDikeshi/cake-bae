...
<<<<<<< HEAD
            ...
            <div className="flex flex-nowrap gap-1 bg-[#F7F1FB] p-1 rounded-lg border border-[#9D5CDB]/12 self-start overflow-x-auto">
=======
...
<<<<<<< HEAD
                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-bold border transition-all duration-200 shrink-0 whitespace-nowrap group ${active ? 'border-[#9D5CDB] bg-[#9D5CDB] text-white' : 'border-[#9D5CDB]/20 bg-[#F7F1FB] text-[#9D5CDB]'} hover:bg-[#2F0538] hover:border-[#9D5CDB] hover:text-white`}
=======
