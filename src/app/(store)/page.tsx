...
import { Sparkles, Truck, Clock, Calendar, ChevronRight, MessageCircle, Heart, Star } from "lucide-react";
  ...
  const categoriesList = [
    {
      ...
      count: "15+ Designs",
      icon: "🎂",
      color: "bg-white border-[#9D5CDB]/15 text-[#2F0538] hover:bg-[#F7F1FB]/40"
    },
    {
      name: "Cupcakes",
    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-7 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  href="/shop"
                  className="w-full sm:w-auto text-center px-8 py-4 bg-[#9D5CDB] hover:bg-[#2F0538] text-white font-bold rounded-xl shadow-lg shadow-[#9D5CDB]/30 transition-all duration-300 transform hover:-translate-y-0.5"
                >
                  Order Online Now
                </Link>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative">
                <div className="absolute -inset-4 rounded-full bg-gradient-to-br from-[#9D5CDB]/30 to-[#4A1054]/20 blur-2xl"></div>
                <div className="relative w-80 h-80 sm:w-96 sm:h-96 rounded-full border-4 border-[#9D5CDB]/50 overflow-hidden shadow-2xl bg-[#1E0124]">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#241129]/65 max-w-xl mx-auto text-sm sm:text-base">
      ...
      <section className="bg-gradient-to-b from-[#F7F1FB] to-[#F7F1FB]/30 py-20 border-y border-[#9D5CDB]/15">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
            <div className="text-center sm:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-[#9D5CDB] font-bold text-xs tracking-wider uppercase border border-[#9D5CDB]/15 shadow-sm mb-3">
                <span>Fan Favorites</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-black text-[#2F0538]">Trending Bestsellers</h2>
              <p className="text-[#241129]/60 text-sm mt-1">Our most loved signature cake recipes & dessert combinations.</p>
            </div>
            <Link
              href="/shop"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {bestSellers.map((product) => (
              <div
                key={product.id}
                className="bg-white rounded-2xl border border-[#9D5CDB]/15 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full group hover:-translate-y-1"
              >
                {/* Image */}
                ...
                <div className="p-5 flex-grow flex flex-col justify-between space-y-4">
                  <div className="space-y-1">
                    <span className="text-[10px] font-bold text-[#9D5CDB] tracking-wider uppercase">
                      {product.category}
                    </span>
                    <h3 className="text-base font-bold text-[#2F0538] line-clamp-1">{product.name}</h3>
                    <p className="text-xs text-[#241129]/65 line-clamp-2 leading-relaxed">{product.description}</p>
                  </div>

                  <div className="flex items-center justify-between pt-2">
                    <span className="text-base font-bold text-[#2F0538]">
                      Rs. {product.price.toLocaleString()}
                    </span>
                    <Link
                      href={`/shop/${product.id}`}
                      className="px-3.5 py-1.5 bg-[#9D5CDB] hover:bg-[#2F0538] text-white hover:text-white text-xs font-bold rounded-lg transition-colors duration-300 inline-flex items-center gap-1"
                    >
                      <span>Customize</span>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        <div className="p-7 border border-[#9D5CDB]/15 rounded-2xl bg-white space-y-3 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          <div className="w-12 h-12 rounded-xl bg-[#F7F1FB] border border-[#9D5CDB]/15 flex items-center justify-center text-[#9D5CDB] mx-auto md:mx-0">
            <Calendar className="w-6 h-6" />
          </div>
          <h3 className="text-lg font-bold text-[#2F0538]">Booking Calendar</h3>
          <p className="text-sm text-[#241129]/60 leading-relaxed">
        ...
        <div className="p-7 border border-[#9D5CDB]/15 rounded-2xl bg-white space-y-3 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          ...
          <h3 className="text-lg font-bold text-[#2F0538]">Prompt Home Delivery</h3>
          <p className="text-sm text-[#241129]/60 leading-relaxed">
        ...
        <div className="p-7 border border-[#9D5CDB]/15 rounded-2xl bg-white space-y-3 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          ...
          <h3 className="text-lg font-bold text-[#2F0538]">Freshness Guaranteed</h3>
          <p className="text-sm text-[#241129]/60 leading-relaxed">
      ...
      <section id="about" className="relative overflow-hidden bg-[#2F0538] text-white py-24">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative">
              <div className="absolute -inset-3 rounded-full bg-gradient-to-br from-[#9D5CDB]/20 to-[#4A1054]/10 blur-2xl"></div>
              <div className="relative w-80 h-80 rounded-full border-8 border-[#1E0124] overflow-hidden shadow-2xl bg-[#4A1054]">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/logo.jpg"
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 text-[#9D5CDB] font-bold text-xs tracking-wider uppercase">
                <Heart className="w-3.5 h-3.5 fill-[#9D5CDB] text-[#9D5CDB]" />
                <span>Behind Cake Bae</span>
              </div>
              <Link
                href="/about"
                className="inline-flex items-center gap-1.5 font-bold text-[#9D5CDB] hover:text-white group text-sm shrink-0"
              >
                <span>Read Full Story</span>
                <ChevronRight className="w-4 h-4 group-hover:translate-x-0.5 transition" />
              </Link>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold leading-tight">Our Sweet Story</h2>
            ...
            <div className="pt-4 border-t border-white/10 flex items-center gap-4">
              <div>
                ...
                <p className="text-xs text-[#9D5CDB] font-semibold">Founder & Head Baker, Cake Bae</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="gallery" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
          <div className="text-center sm:text-left space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-[#2F0538]">Sweet Inspiration Gallery</h2>
            <p className="text-[#241129]/60 max-w-xl text-sm sm:text-base">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {galleryProducts.map((product) => (
            <div
              key={product.id}
              className="relative aspect-square rounded-2xl overflow-hidden group bg-white border border-[#9D5CDB]/15 shadow-sm hover:shadow-xl transition-all duration-300"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={product.image}
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1E0124]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end p-4">
      ...
      {/* FAQ Section */}
      <section id="faq" className="bg-gradient-to-b from-[#F7F1FB]/50 to-white py-20 border-t border-[#9D5CDB]/15">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
            <div className="text-center sm:text-left space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-[#9D5CDB] font-bold text-xs tracking-wider uppercase border border-[#9D5CDB]/15 shadow-sm">
                <span>Got Questions?</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#2F0538]">Frequently Asked Questions</h2>
              <p className="text-[#241129]/60 text-sm sm:text-base">
              ...
              return (
                <div
                  ...
                  className={`border rounded-2xl bg-white overflow-hidden transition-all duration-300 ${
                    isOpen ? "border-[#9D5CDB]/45 shadow-md" : "border-[#9D5CDB]/15 shadow-sm hover:shadow-md"
                  }`}
                >
                  <button
                    onClick={() => setActiveFAQ(isOpen ? null : index)}
                    className="w-full flex items-center justify-between gap-4 p-5 text-left font-bold text-[#241129] hover:text-[#9D5CDB] transition"
                  >
                    <span>{faq.question}</span>
                    <span
                      className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 border transition-all duration-300 text-[#9D5CDB] ${
                        isOpen ? "bg-[#F7F1FB] border-[#9D5CDB]/30 rotate-45" : "bg-white border-[#9D5CDB]/15"
                      }`}
                    >
                      +
                    </span>
                  ...
                  >
                    <div className="overflow-hidden">
                      <div className="p-5 pt-0 text-sm text-[#241129]/75 border-t border-[#9D5CDB]/10 bg-[#F7F1FB]/10 leading-relaxed">
                        {faq.answer}
                      </div>
                    </div>
                  </div>
