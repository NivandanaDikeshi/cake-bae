...
=======
      ...
      {/* Page Hero */}
      <section className="relative overflow-hidden bg-[#2F0538] text-white py-24 sm:py-32">
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
        <motion.div
...
=======
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 text-[#C292F0] font-semibold text-xs tracking-[0.15em] uppercase border border-white/10"
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
          >
...
=======
          <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1]">
            Our Sweet <span className="text-[#C292F0]">Story</span>
          </motion.h1>

          <motion.p variants={fadeUp} className="text-purple-100/80 text-base sm:text-lg font-medium leading-relaxed">
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
...
=======
              <div className="absolute -inset-3 rounded-full bg-purple-100 blur-2xl opacity-60" />
              <div className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-full border-[6px] border-white overflow-hidden shadow-2xl bg-[#2F0538] ring-1 ring-purple-100">
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
...
=======
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-50 border border-purple-100 text-[#8545C2] font-bold text-xs tracking-wider uppercase">
              <span>Meet The Baker</span>
            </motion.div>
            <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#2F0538] leading-tight">
              Hi, I'm Savi Wijayalath
            </motion.h2>
            <motion.p variants={fadeUp} className="text-slate-600 leading-relaxed text-base sm:text-lg">
              Founder and head pastry chef at Cake Bae. My passion for baking started in my home kitchen in Rajagiriya, experimenting with rich flavors and minimalist frosting designs that bring joy to celebrations.
            </motion.p>
            <motion.p variants={fadeUp} className="text-slate-500 text-sm sm:text-base leading-relaxed">
              At Cake Bae, we believe a cake is not just a dessert — it's the centerpiece of your most treasured celebrations. That's why we pour our heart into every custom order, sourcing premium Belgian chocolate, Australian cream cheese, and fresh fruits.
            </motion.p>
            <motion.div variants={fadeUp} className="pt-6 border-t border-slate-100 flex items-center justify-between flex-wrap gap-5">
              <div>
                <h5 className="font-black text-slate-800 text-base">Savi Wijayalath</h5>
                <p className="text-xs text-[#8545C2] font-bold tracking-wide">FOUNDER & HEAD BAKER, CAKE BAE</p>
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
              </div>
              <motion.a
                whileHover={{ y: -2 }}
...
=======
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 text-[#8545C2] font-bold text-xs tracking-wider uppercase border border-purple-100">
            <span>What Drives Us</span>
          </motion.div>
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-black text-[#2F0538]">
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
            Vision &amp; Mission
          </motion.h2>
        </motion.div>
...
=======
          className="relative grid grid-cols-1 md:grid-cols-2 rounded-3xl overflow-hidden border border-[#2F0538]/10 shadow-xl shadow-purple-900/5 bg-[#2F0538]"
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
        >
...
=======
                <item.icon className="w-7 h-7 text-[#C292F0]" strokeWidth={2} />
              </div>
              <div className="space-y-3">
                <span className="inline-block text-xs font-bold tracking-[0.18em] uppercase text-[#C292F0]">
                  {item.label}
                </span>
                <h3 className="text-xl sm:text-2xl font-black text-white leading-snug">{item.title}</h3>
                <p className="text-purple-100/70 text-sm sm:text-base leading-relaxed">{item.description}</p>
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
              </div>
            </motion.div>
          ))}
...
=======
                ...
                <p className="text-[11px] sm:text-xs text-[#C292F0] font-bold tracking-wider uppercase mt-2">{stat.label}</p>
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
              </motion.div>
            ))}
          </div>
...
=======
              className="p-7 rounded-2xl border border-purple-100 bg-purple-50/30 hover:bg-purple-50 transition-colors duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-white border border-purple-100 flex items-center justify-center shadow-sm mb-5">
                <value.icon className="w-6 h-6 text-[#8545C2]" />
              </div>
              <h3 className="text-base font-black text-[#2F0538] mb-2">{value.title}</h3>
...
=======
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 text-[#C292F0] font-semibold text-xs tracking-wider uppercase border border-white/10">
              <span>Let's Celebrate Together</span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight">
              Ready to Order Your Sweet Moment?
            </h2>
            <p className="text-purple-100/80 max-w-xl mx-auto text-sm sm:text-base font-medium leading-relaxed">
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
...
=======
                  className="w-full sm:w-auto text-center block px-8 py-4 bg-[#9D5CDB] hover:bg-[#8545C2] text-white font-bold rounded-xl shadow-lg shadow-[#9D5CDB]/30 transition-colors"
>>>>>>> 361d8431e4c3dd781c757de7630e56f73e3f6744
                >
                  Order Online Now
                </Link>
